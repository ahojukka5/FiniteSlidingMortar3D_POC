"""Event-aware scale-aware augmented contact orchestration."""
...
from ..results import AugmentedContactOptions
from ..scaling import (
...
class EventAwareScaleAwareAugmentedContactResult:
    ...
    def events(self) -> tuple[ContactTopologyEventBatch, ...]:
        ...
        return tuple(
            batch for equilibrium in self.equilibria for batch in equilibrium.events
        )
